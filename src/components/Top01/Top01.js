...
import * as styles from "./Top01.module.css";

const Top01 = () => {
    return (
        <div className={styles.Top01}>
            <img src="/Top/Background.jpg" alt="Background" className={styles.Background}/>
